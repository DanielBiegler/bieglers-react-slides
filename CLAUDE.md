...
- **`Slide.*` namespace is for layouts only** — `Slide.Cover`, `Slide.CoverCentered`, `Slide.CoverSplit`, `Slide.Centered`, `Slide.Split`, `Slide.Showcase`. Never add content components here.
